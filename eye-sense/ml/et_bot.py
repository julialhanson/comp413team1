...
def simulate_derm_gaze(filepath, num_border_points=3000, num_internal_points=2000, visualize=False):
    # Load and zoom
...
for file in files:
    simulate_derm_gaze(f'dataset/images/{file}')

# simulate_derm_gaze('lesion.jpg', visualize=True)
